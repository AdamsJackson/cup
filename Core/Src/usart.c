...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = DBG_TX_Pin|GPIO_PIN_10;
...
void HAL_USART_MspInit(USART_HandleTypeDef* usartHandle)
{
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    PC8     ------> USART6_CK
    */
    GPIO_InitStruct.Pin = OMV_TX_Pin|OMV_RX_Pin|GPIO_PIN_8;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, DBG_TX_Pin|GPIO_PIN_10);
...
void HAL_USART_MspDeInit(USART_HandleTypeDef* usartHandle)
{
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC8     ------> USART6_CK
    */
    HAL_GPIO_DeInit(GPIOC, OMV_TX_Pin|OMV_RX_Pin|GPIO_PIN_8);
